...
|----|-------------|------------------|
| ING-01 | User can submit a public TikTok video URL from a website. [VERIFIED: .planning/REQUIREMENTS.md] | Add a React URL form inside `AppShell`, call a FastAPI submission endpoint, and return a job UUID. [VERIFIED: 02-UI-SPEC.md] |
