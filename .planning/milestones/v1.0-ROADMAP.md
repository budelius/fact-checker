...
Fact Checker v1.0 ships the first end-to-end user-owned AI research fact-checking loop: TikTok-oriented ingestion, claim extraction, paper/preprint discovery, paper processing, evidence-backed reports, Markdown/MongoDB/Qdrant persistence, and a page-first knowledge browser with search, graph inspection, consistency checks, annotations, and evidence-state ratings.
